...
class IBvUDPingPong(TrafficTest):
    def __init__(self, logger=None, setup_file=None, test_file=None):
        super(IBvUDPingPong, self).__init__(logger, setup_file, test_file)
        self.caseToTests = {}
            ...
            for s_dev, c_dev in self.RDMAPairs.items():
                for s_port in s_dev.Ports:
                    ...
                    for s_gid in s_port.V1GIDs:
                        ...
                        tests.append(IBvXXPingPong(self.Logger, self.Server, self.Client, "ud", s_dev.Name, c_dev.Name,
